  ...
  return (
    <div className="w-full max-w-4xl bg-muted rounded-2xl p-4 flex flex-col items-start space-y-4 font-dm-sans">
      <input
        ...
        className="flex-1 w-full text-muted-foreground bg-transparent text-lg placeholder-muted-foreground focus:outline-none"
      />
      ...
      <div className="flex items-center justify-between space-x-2 w-full">
        <div className="flex items-center space-x-4">
          ...
          <button className="flex items-center space-x-2 bg-primary-foreground hover:bg-gray-600 px-3 py-2 rounded-lg transition-colors">
